...
export function Header({ title }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-40 bg-background/95 dark:bg-background/98 backdrop-blur-xl border-b border-border dark:border-b-[1.5px] dark:border-b-[hsl(42_85%_55%_/_0.3)] dark:shadow-[0_1px_25px_hsl(42_85%_55%_/_0.12)]">
