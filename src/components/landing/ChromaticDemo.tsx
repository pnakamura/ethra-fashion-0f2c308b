        ...
        <div className="text-center mb-6">
          ...
          <h3 className="font-display text-2xl font-semibold">
            ...
            <span className="text-gradient">
              {demoResult.season_name} {demoResult.subtype}
            </span>
            !
          </h3>
          <p className="text-sm text-muted-foreground mt-1">{demoResult.confidence}% de confiança</p>
        </div>
  ...
  return (
    ...
    >
      <div className="text-center mb-6">
        ...
        <h3 className="font-display text-2xl font-semibold mb-2">Descubra suas cores em 10 segundos</h3>
        <p className="text-muted-foreground text-sm">Análise cromática gratuita com inteligência artificial</p>
      </div>
      ...
      <label className="block">
        ...
        <div className="border-2 border-dashed border-border rounded-2xl p-8 cursor-pointer hover:border-primary/50 hover:bg-primary/5 transition-all group">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">Com luz natural, sem maquiagem pesada</p>
          </div>
        </div>
      </label>
