    ...
    return (
      <div className="py-16 text-center">
        <p className="text-muted-foreground mb-4">
          Nenhuma peça com compatibilidade "{filterLabel}"
        </p>
    ...
    >
      ...
      >
        <h3 className="text-xl font-display font-semibold text-foreground">
          Seu closet está esperando
        </h3>
        <p className="text-sm text-muted-foreground max-w-[260px] mx-auto leading-relaxed">
          Adicione suas peças favoritas e descubra combinações perfeitas com IA
        </p>
      </motion.div>
      ...
      >
        <Button
          onClick={onAddItem}
          className="rounded-xl gradient-primary text-primary-foreground px-6"
          size="lg"
        >
      ...
      >
        ...
        <span>Tire uma foto e a IA analisa as cores automaticamente</span>
